...
<!-- Title, Description and Author ----------------------------------------- -->
	<title>Amichiamoci | Basket</title>
	<meta name="description" content="Informazioni sui tornei di basket">
	<meta name="author" content="Leonardo Puccini">

<!-- Open Graph ------------------------------------------------------------ -->
	<meta property="og:title" content="Amichiamoci | Basket">
	<meta property="og:type" content="website">
	<meta property="og:url" content="https://www.amichiamoci.it/tornei/basket.php/">
	<meta property="og:description" content="Informazioni sui tornei di basket">
	...
	<section id="over" class="over overlap">
		<div class="overlap-box">
			<div class="overlap-image">
				<img src="../assets/images/tornei/basket-over.jpg">
			</div>
			<div class="overlap-content">
				...
				<!--
				<a class="button" href="../assets/docs/Regole Basket Over.pdf">
					Regolamento
...
<section id="under" class="under overlap">
	<div class="overlap-box">
		<div class="overlap-image">
			<img src="../assets/images/tornei/basket-under.jpg">
		</div>
		<div class="overlap-content">
			<h2>Basket under</h2>
			<!-- TODO: Aggiornare la pagina e inserire il regolamento -->
			...
			<!--
			<a class="button" href="../assets/docs/Regole Basket Under.pdf">
				Regolamento
				<i class="fa-solid fa-download"></i>
			</a>
			-->
