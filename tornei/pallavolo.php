...
<!-- Title, Description and Author ----------------------------------------- -->
	<title>Amichiamoci | Pallavolo</title>
	<meta name="description" content="Informazioni sui tornei di pallavolo">
	<meta name="author" content="Leonardo Puccini">

<!-- Open Graph ------------------------------------------------------------ -->
	<meta property="og:title" content="Amichiamoci | Pallavolo">
	<meta property="og:type" content="website">
	<meta property="og:url" content="https://www.amichiamoci.it/tornei/pallavolo.php/">
	<meta property="og:description" content="Informazioni sui tornei di pallavolo">
	...
	<section id="over" class="over overlap">
		<div class="overlap-box">
			<div class="overlap-image">
				<img src="../assets/images/tornei/pallavolo-over.jpg">
			</div>
			<div class="overlap-content">
				<h2>Pallavolo over</h2>
				...
				<!--
				<a class="button" href="../assets/docs/Regole Pallavolo Over.pdf">
					Regolamento
...
<!-- Pallavolo Under ------------------------------------------------------- -->
	<section id="under" class="under overlap">
		<div class="overlap-box">
			<div class="overlap-image">
				<img src="../assets/images/tornei/pallavolo-under.jpg">
			</div>
			<div class="overlap-content">
				<h2>Pallavolo under</h2>
				<!-- TODO: Aggiornare la pagina e inserire il regolamento -->
				<p>
					Lo staff sta ancora lavorando all'organizzazione della
					nuova edizione di Amichiamoci 2024. Seguici sui nostri
				...
				<!--
				<a class="button" href="../assets/docs/Regole Pallavolo Under.pdf">
					Regolamento
					<i class="fa-solid fa-download"></i>
				</a>
				-->
