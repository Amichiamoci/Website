...
<!-- Title, Description and Author ----------------------------------------- -->
	<title>Amichiamoci | Calcio</title>
	<meta name="description" content="Informazioni sui tornei di calcio">
	<meta name="author" content="Leonardo Puccini">

<!-- Open Graph ------------------------------------------------------------ -->
	<meta property="og:title" content="Amichiamoci | Calcio">
	<meta property="og:type" content="website">
	<meta property="og:url" content="https://www.amichiamoci.it/tornei/calcio.php/">
	<meta property="og:description" content="Informazioni sui tornei di calcio">
...
<!-- Header ---------------------------------------------------------------- -->
	<header>
		...
		<ul class="navbar">
			...
			<li><a href="#female">Femminile</a></li>
...
<!-- Soccer Over ----------------------------------------------------------- -->
	<section id="over" class="over overlap">
		<div class="overlap-box">
			<div class="overlap-image">
				<img src="../assets/images/tornei/calcio-over.jpg">
			</div>
			<div class="overlap-content">
				...
				<!--
				<a class="button" href="../assets/docs/Regole Calcio Over.pdf">
					Regolamento
...
<!-- Soccer Under ---------------------------------------------------------- -->
	<section id="under" class="under overlap">
		<div class="overlap-box">
			<div class="overlap-image">
				<img src="../assets/images/tornei/calcio-under.jpg">
			</div>
			<div class="overlap-content">
				<h2>Calcio under</h2>
				<!-- TODO: Aggiornare la pagina e inserire il regolamento -->
				...
				<!--
				<a class="button" href="../assets/docs/Regole Calcio Under.pdf">
					Regolamento
					<i class="fa-solid fa-download"></i>
				</a>
				-->
...
<!-- Soccer Female --------------------------------------------------------- -->
	<section id="female" class="female overlap">
		<div class="overlap-box">
			<div class="overlap-image">
				<img src="../assets/images/tornei/calcio-femminile.jpg">
			</div>
			<div class="overlap-content">
				...
				<!--
				<a class="button" href="../assets/docs/Regole Calcio Femminile.pdf">
					Regolamento
					<i class="fa-solid fa-download"></i>
				</a>
				-->
