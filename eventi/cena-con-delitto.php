...
<!-- Title, Description and Author ----------------------------------------- -->
	<title>Amichiamoci | Cena con Delitto</title>
	<meta name="description" content="Informazioni sulla cena con delitto">
	<meta name="author" content="Leonardo Puccini">

<!-- Open Graph ------------------------------------------------------------ -->
	<meta property="og:title" content="Amichiamoci | Cena con Delitto">
	<meta property="og:type" content="website">
	<meta property="og:url" content="https://www.amichiamoci.it/eventi/cena-con-delitto.php/">
	<meta property="og:description" content="Informazioni sulla cena con delitto">
...
<!-- Header ---------------------------------------------------------------- -->
	<header>
		...
		<ul class="navbar">
			<li><a href="#event">Cena con Delitto</a></li>
	...
	<section id="event" class="event overlap">
		<div class="overlap-box">
			...
			<div class="overlap-content">
				...
				<!--
				<a class="button" href="../assets/docs/Volantino Cena con Delitto.pdf">
					Volantino
