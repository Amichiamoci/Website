...
<!-- Title, Description and Author ----------------------------------------- -->
	<title>Amichiamoci | Caccia al Tesoro</title>
	<meta name="description" content="Informazioni sulla caccia al tesoro">
	<meta name="author" content="Leonardo Puccini">

<!-- Open Graph ------------------------------------------------------------ -->
	<meta property="og:title" content="Amichiamoci | Caccia al Tesoro">
	<meta property="og:type" content="website">
	<meta property="og:url" content="https://www.amichiamoci.it/eventi/caccia-al-tesoro.php/">
	<meta property="og:description" content="Informazioni sulla caccia al tesoro">
...
<!-- Header ---------------------------------------------------------------- -->
	<header>
		...
		<ul class="navbar">
			<li><a href="#event">Caccia al Tesoro</a></li>
	...
	<section id="event" class="event overlap">
		<div class="overlap-box">
			...
			<div class="overlap-content">
				...
				<!--
				<a class="button" href="../assets/docs/Volantino Caccia al Tesoro.pdf">
					Volantino
