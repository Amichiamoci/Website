...
<!-- Title, Description and Author ----------------------------------------- -->
	<title>Amichiamoci | Festa Finale</title>
	<meta name="description" content="Informazioni sulla festa finale">
	<meta name="author" content="Leonardo Puccini">

<!-- Open Graph ------------------------------------------------------------ -->
	<meta property="og:title" content="Amichiamoci | Festa Finale">
	<meta property="og:type" content="website">
	<meta property="og:url" content="https://www.amichiamoci.it/eventi/festa-finale.php/">
	<meta property="og:description" content="Informazioni sulla festa finale">
...
<!-- Header ---------------------------------------------------------------- -->
	<header>
		...
		<ul class="navbar">
			<li><a href="#event">Festa Finale</a></li>
	...
	<section id="event" class="event overlap">
		<div class="overlap-box">
			...
			<div class="overlap-content">
				...
				<!--
				<a class="button" href="../assets/docs/Volantino Festa Finale.pdf">
					Volantino
