...
<!-- Title, Description and Author ----------------------------------------- -->
	<title>Amichiamoci | Santa Messa</title>
	<meta name="description" content="Informazioni sulla Santa Messa">
	<meta name="author" content="Leonardo Puccini">

<!-- Open Graph ------------------------------------------------------------ -->
	<meta property="og:title" content="Amichiamoci | Santa Messa">
	<meta property="og:type" content="website">
	<meta property="og:url" content="https://www.amichiamoci.it/eventi/santa-messa.php/">
	<meta property="og:description" content="Informazioni sulla Santa Messa">
...
<!-- Header ---------------------------------------------------------------- -->
	<header>
		...
		<ul class="navbar">
			<li><a href="#event">Santa Messa</a></li>
	...
	<section id="event" class="event overlap">
		<div class="overlap-box">
			...
			<div class="overlap-content">
				...
				<!--
				<a class="button" href="../assets/docs/Volantino Santa Messa.pdf">
					Volantino
