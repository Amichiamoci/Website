...
<!-- Title, Description and Author ----------------------------------------- -->
	<title>Amichiamoci | Chi siamo</title>
	<meta name="description" content="Storia di Amichiamoci">
	<meta name="author" content="Leonardo Puccini">

<!-- Open Graph ------------------------------------------------------------ -->
	<meta property="og:title" content="Amichiamoci | Chi siamo">
	<meta property="og:type" content="website">
	<meta property="og:url" content="https://www.amichiamoci.it/chi-siamo.php/">
	<meta property="og:description" content="Storia di Amichiamoci">
...
<!-- Header ---------------------------------------------------------------- -->
	<header>
		...
		<ul class="navbar">
			<li><a href="#about-1">L'Inizio</a></li>
			<li><a href="#about-2">Amichiamoci</a></li>
...
<!-- About ----------------------------------------------------------------- -->
	...
	<section id="about-2" class="about overlap">
		<div class="overlap-box">
			<!-- TODO: trovare un'immagine e togliere la classe "no-image" -->
			<div class="overlap-image no-image">
				<!-- <img src="assets/images/amichiamoci.jpg"> -->
			</div>
			<div class="overlap-content no-image text-content">
				<h2>Amichiamoci</h2>
				<p>
	                ...
	                che ormai da qualche anno era stata abbandonata.<br><br>

	                "Amichiamoci", in cui i protagonisti sono giovani dai 13 ai
	                30 anni, da allora si svolge ogni anno a settembre.<br><br>
	                ...
	                a 8, pallavolo e basket 3 vs 3.<br><br>

	                Nel corso degli anni sempre pi&ugrave; Parrocchie - e non
