...
<a class="button" style="margin-top: .3em; margin-right: .5em;" href="{{ "/chi-siamo" | relative_url }}">Leggi di più</a>
<a class="button" style="margin-top: .3em; margin-inline: .5em;" href="{{ "/beneficienza" | relative_url }}">Aiutare il prossimo</a>